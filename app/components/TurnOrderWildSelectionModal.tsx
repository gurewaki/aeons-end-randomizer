...
/**
 * ワイルド公開時、対応するプレイヤー番号を選ぶための Modal。
 * 選択結果は捨て札に「ワイルド → P3」のように記録される。
 */
export function TurnOrderWildSelectionModal({
  open,
  candidates,
  onSelect,
}: {
  open: boolean;
  candidates: PlayerValue[];
  ...
  return (
    <Modal
      ...
      labelledBy="wild-title"
    >
      <div className="space-y-4">
        <div>
          <h2 id="wild-title" className="text-xl font-bold text-slate-50">
            ワイルドカードを公開
          </h2>
          <p className="mt-1 text-xs text-slate-400">
            このターンを実行するプレイヤーを選んでください
          </p>
        </div>
